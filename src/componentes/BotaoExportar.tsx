...
/**
 * Ação principal do app, sempre à mão no topo: baixa o PNG na resolução exata
 * do formato. JPG, "baixar os dois" e o resumo continuam na aba Exportar.
 */
export function BotaoExportar() {
  ...
  return (
    <button
      ...
      title={
        temFoto
          ? 'Baixar a colagem em PNG, na resolução exata do formato'
    ...
    >
      ...
      {ocupado ? 'Exportando…' : concluido ? 'Baixado!' : 'Exportar PNG'}
    </button>
  )
}
